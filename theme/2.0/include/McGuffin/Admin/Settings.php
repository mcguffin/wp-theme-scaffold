...
class Settings extends Core\Singleton {
	...
	protected function __construct() {
		...
		// add default options
		add_option( 'mcguffin_404_page', 0 );
	...
	public function input_text( $args ){
		...
		?>
		<input class="regular-text ltr" name="<?php echo $args['option_name'] ?>" value="<?php echo $setting ?>" />
		<?php
	...
	public function select_page( $args ){
		...
		?>
		<label for="<?php echo $args['option_name']; ?>">
			<?php
