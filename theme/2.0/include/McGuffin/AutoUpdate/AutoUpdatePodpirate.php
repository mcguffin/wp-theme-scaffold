...
class AutoUpdatePodpirate extends AutoUpdate {
	 ...
	 *	@inheritdoc
	 */
	public function get_remote_release_info( $slug ) {

		if ( $release_info_url = $this->get_release_info_url( $slug ) ) {
			...
			if ( ! is_wp_error( $response ) ) {
				...
				), $release_info->download_link );error_log(var_export($release_info->download_link,true));
	 ...
	 */
	private function get_release_info_url( $slug ) {
